...
/* Simple font characters are rotated by 90 degree*/
uint8_t font8x8_basic_tr[117][8] = {
    { 0xe0, 0xe0, 0x00, 0xfc, 0xfc, 0x00, 0xff, 0xff },   // U+000B (Signal High)
    { 0xe0, 0xe0, 0x00, 0xfc, 0xfc, 0x00, 0x00, 0x00 },   // U+000C (Signal Mid)
    { 0xe0, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   // U+000D (Signal Low)
    { 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00 },   // U+000E (Disconnected)
    { 0x01, 0x03, 0x07, 0xff, 0x07, 0x03, 0x01, 0x00 },   // U+000F (Antenna symbol)
    { 0x00, 0x1f, 0x13, 0x15, 0x15, 0x13, 0x1f, 0x00 },   // U+0010 (Envelope symbol)
